            ...
            <div className="w-full max-w-md rounded-lg py-10 px-6 lg:px-8 bg-slate-900">
                ...
                className="mt-4 flex flex-col gap-[2px]">
                        ...
                        <div className="w-full flex justify-end text-gray-400">
                            <span className="italic mr-1">test email </span>: test@admin.com
                        </div>
                        ...
                        <div className="w-full flex justify-end mb-[6px] text-gray-400">
                            <span className="italic mr-1">test password</span>: 12345678
                        </div>
